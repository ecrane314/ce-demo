...
https://cloud.google.com/dlp/docs/redacting-sensitive-data-images#code_examples
https://github.com/googleapis/python-dlp/blob/HEAD/samples/snippets/redact.py 
https://docs.python.org/3.8/library/argparse.html
https://googleapis.dev/python/dlp/latest/dlp_v2/dlp_service.html 
VEHICLE_IDENTIFICATION_NUMBER is an info_type
"""
...
if __name__ == "__main__":
    ...
    common_args_parser.add_argument("--project",
        help="The Google Cloud project id to use as a parent resource.",
        default=default_project,
    )
    common_args_parser.add_argument("filename", help="The path to the file to inspect.")
    common_args_parser.add_argument("output_filename", help="The path to which the redacted image will be written.",
    )
    ...
    #  USE ONLY FOR info_types_parser
...
# python redact-ec.py info_types  --project "sc-nlp" "VIN.jpeg" "vinout.jpeg" --info_types "VEHICLE_IDENTIFICATION_NUMBER"
# python ../ce-demo/dlp/redact-ec.py info_types  --project "sc-nlp" "VIN2.jpeg" "vinout.jpeg" --info_types "VEHICLE_IDENTIFICATION_NUMBER"
# python ../ce-demo/dlp/redact-ec.py all_text  --project "sc-nlp" "VIN.jpeg" "vinout.jpeg"
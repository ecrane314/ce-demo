...
def speechRecognize(srcBucket, srcPrefix, destPrefix):
	...
	config = speech.types.RecognitionConfig(
            encoding=LINEAR16 #read in common docs, not python API 
                # not sure here? speech.enums.RecognitionConfig.AudioEncoding.LINEAR16,
